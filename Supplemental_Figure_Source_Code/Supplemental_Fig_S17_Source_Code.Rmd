---
title: "t-SNE Analysis of Non-diabetic and Type 2 Diabetic Single Cell Ensemble Transcriptomes"
output: 
  pdf_document:
  fig_caption: yes
---
...
This file will detail the steps used to perform unsupervised t-SNE analysis on the combined non-diabetic and type 2 diabetic single cell transcriptomes. The data was reduced to two dimensions.
...
# Identify the epsilon cell (high GHRL expression)
...
# Specify phenotype of each of single cell samples
...
# Specify the shape for T2D and NonT2D in the plot 
type1 <- NULL
...
legend("bottomleft", legend = c(expression(bold("Beta (INS)")), expression(bold("Alpha (GCG)")), 
...
legend(-12,-15, legend = c("NonT2D", "T2D"), pch = c(20,17), cex = 0.75)
